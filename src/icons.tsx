...
export const Ico = {
  ...
  palette: (s=14) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="13.5" cy="6.5" r="1"/><circle cx="17.5" cy="10.5" r="1"/><circle cx="8.5" cy="7.5" r="1"/><circle cx="6.5" cy="12.5" r="1"/><path d="M12 2C6.5 2 2 6.5 2 12a10 10 0 0 0 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>,
  broadcast: (s = 16) => (
  ...
  // SENU crystal for empty state — uses currentColor so it follows the active theme
  crystal: () => (
    <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
      <polygon points="26,3 3,26 26,26"  fill="currentColor" fillOpacity="0.25"/>
      <polygon points="26,3 49,26 26,26" fill="currentColor" fillOpacity="0.35"/>
      <polygon points="3,26 26,49 26,26" fill="currentColor" fillOpacity="0.85"/>
      <polygon points="49,26 26,49 26,26" fill="currentColor" fillOpacity="0.12"/>
      <line x1="26" y1="3" x2="26" y2="49" stroke="currentColor" strokeOpacity="0.25" strokeWidth="0.7"/>
      <line x1="3" y1="26" x2="49" y2="26" stroke="currentColor" strokeOpacity="0.25" strokeWidth="0.7"/>
    </svg>
  ),
}
